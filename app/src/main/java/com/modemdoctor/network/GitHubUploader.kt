package com.modemdoctor.network
 ...
 * Это позволяет нам делиться логами без настройки сервера
 */
class GitHubUploader(private val context: Context) {
    ...
    companion object {
        ...
        // GitHub Token - set via UI or code
     ...
     * @return URL созданного Gist или null при ошибке
     */
